...
export default function vivaDark() {
    // -------------------------------------------------------------
        ...
        <style jsx global>
            {`
                ...
                @font-face {
                    ...
                    font-weight: 300;
                    src: local(''),
                        url('./fonts/poppins-v15-latin-ext_latin-300.woff2')
                            format('woff2'),
                        url('./fonts/poppins-v15-latin-ext_latin-300.woff')
                ...
                @font-face {
                    ...
                    font-weight: 400;
                    src: local(''),
                        url('./fonts/poppins-v15-latin-ext_latin-regular.woff2')
                            format('woff2'),
                        url('./fonts/poppins-v15-latin-ext_latin-regular.woff')
                            format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
                }
                ...
                @font-face {
                    ...
                    font-weight: 600;
                    src: local(''),
                        url('./fonts/poppins-v15-latin-ext_latin-600.woff2')
                            format('woff2'),
                        url('./fonts/poppins-v15-latin-ext_latin-600.woff')
                            format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
                }
                ...
                @font-face {
                    ...
                    font-weight: 700;
                    src: local(''),
                        url('./fonts/poppins-v15-latin-ext_latin-700.woff2')
                            format('woff2'),
                        url('./fonts/poppins-v15-latin-ext_latin-700.woff')
                            format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
                }
                * {
                ...
                .p-scrolltop.p-link:hover {
                    background: rgba(158, 173, 230, 0.3616);
                }
                ...
                .p-autocomplete.p-autocomplete-multiple:not(
                        .p-disabled
                    ).p-focus {
                    box-shadow: none;
                }
